...
Backend is the shared 360Ghar FastAPI monolith (`../360ghar-backend`) at `/api/v1`. Auth is Supabase. Primary users: real-estate photographers, agencies, PMs, architects; public viewers are buyers/tenants.
