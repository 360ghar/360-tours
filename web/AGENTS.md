...
This app lives at `web/` inside the `360-tours` monorepo; the Flutter mobile client is its sibling at `../mobile` (see `../mobile/AGENTS.md`) and the root `../AGENTS.md` covers cross-app concerns.
