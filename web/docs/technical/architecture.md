...
A native mobile client exists as a monorepo sibling at `mobile/` (Flutter) —
see `mobile/ARCHITECTURE.md`. It is a separate product surface with its own
architecture, not part of this document's scope.
