  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-primary-500)] focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        destructive: 'border-transparent bg-[var(--color-error-50)] text-[var(--color-error-600)]',
        success: 'border-transparent bg-[var(--color-success-50)] text-[var(--color-success-600)]',
        warning: 'border-transparent bg-[var(--color-warning-50)] text-[var(--color-warning-600)]',
        info: 'border-transparent bg-[var(--color-info-50)] text-[var(--color-info-600)]',
